...
##Save the kernel matrix to an npy file for later recall.

np.save('kernel_matrix_train.npy', adhoc_matrix_train)
np.save('kernel_matrix_test.npy', adhoc_matrix_test)
